...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        final JIMSendTextPane txt = new JIMSendTextPane();
        ...
        txt.setBorder(new EmptyBorder(5,5,5,5)); // newLineviaEnter
        ...
        cmd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (!text.equals("")) {
                    Model_Send_Message message = new Model_Send_Message(Service.getInstance().getUser().
                                                                        getUserID(), user.getUserID(), text);
                    send(message);
